...
data_dir = os.path.join(os.path.dirname(pkg_dir), "data/goggles")
...
def _register_children() -> Dict[str, Type[Goggle]]:
    
    created: Dict[str, Type[Goggle]] = {}
    ...
    for class_name, filepath in zip(class_names, filepaths):
        ...
        def __init__(self, _p = filepath):
            Goggle.__init__(self, _p)

        Child = type(class_name, (Goggle, ), {"__init__": __init__, "DATA_PATH": filepath})
