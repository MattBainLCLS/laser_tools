...
data_dir = os.path.join(os.path.dirname(pkg_dir), "data/materials")
...
def _register_children() -> Dict[str, Type[Material]]:
    
    created: Dict[str, Type[Material]] = {}
    ...
    for class_name, filepath in zip(class_names, filepaths):
        ...
        def __init__(self, _p = filepath):
            Material.__init__(self, _p)

        Child = type(class_name, (Material, ), {"__init__": __init__, "DATA_PATH": filepath})
...
__all__ = ["Material", *_created.keys()]
