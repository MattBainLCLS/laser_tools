...
data_dir = os.path.join(os.path.dirname(pkg_dir), "data/polarizers")
...
def _register_children() -> Dict[str, Type[Polarizer]]:
    
    created: Dict[str, Type[Polarizer]] = {}
    ...
    for class_name, filepath in zip(class_names, filepaths):
        ...
        def __init__(self, _p = filepath):
            Polarizer.__init__(self, _p)

        Child = type(class_name, (Polarizer, ), {"__init__": __init__, "DATA_PATH": filepath})
...
__all__ = ["Polarizer", *_created.keys()]
