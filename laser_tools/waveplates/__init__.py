...
data_dir = os.path.join(os.path.dirname(pkg_dir), "data/waveplates")
...
def _register_children() -> Dict[str, Type[Waveplate]]:
    
    created: Dict[str, Type[Waveplate]] = {}
    ...
    for class_name, filepath in zip(class_names, filepaths):
        ...
        def __init__(self, _p = filepath):
            Waveplate.__init__(self, _p)

        Child = type(class_name, (Waveplate, ), {"__init__": __init__, "DATA_PATH": filepath})
...
__all__ = ["Waveplate", *_created.keys()]
